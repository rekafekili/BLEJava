...
public class BluetoothActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnSendData.setOnClickListener(view -> {
            if(mThreadConnectedBluetooth != null) {
                ...
                Toast.makeText(getApplicationContext(), "Write : " + mTvSendData.getText().toString(), Toast.LENGTH_LONG).show();
                mTvSendData.setText("");
            }
        });
    ...
    void connectSelectedDevice(String selectedDeviceName) {
        ...
        try {
            ...
            ((BluetoothSocket) mBluetoothSocket).connect();
            mThreadConnectedBluetooth = new ConnectedBluetoothThread(mBluetoothSocket);
            mThreadConnectedBluetooth.start();
            Toast.makeText(getApplicationContext(), "블루투스 연결 쓰레드 시작", Toast.LENGTH_LONG).show();
